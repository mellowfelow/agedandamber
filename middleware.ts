...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|admin|order|_next|\\.well-known|thank-you-contact|thank-you-order|thank-you-wholesale|favicon.svg|llms.txt|auth.md|robots.txt|sitemap.xml|images|js|fonts).*)',
  ],
};
