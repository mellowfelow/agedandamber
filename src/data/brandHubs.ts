...
export const BRAND_HUBS: BrandHub[] = [
  ...
  {
    categorySlug: 'fine-wine', hubSlug: '19-crimes', brandKeywords: ['19 Crimes'], name: '19 Crimes',
    seo: brandSeo({
      brand: '19 Crimes', categoryLabel: 'Red Wine',
      titleTag: '19 Crimes — Cabernet Sauvignon & Red Blend',
      h1: '19 Crimes Wine — Cabernet Sauvignon Allocations',
      metaDescription: 'Buy 19 Crimes online — Cabernet Sauvignon from the Australian penal-colony-branded, Snoop Dogg-associated wine label. Direct allocations at Aged & Amber.',
      hook: '19 Crimes built massive brand recognition around its Australian penal-colony branding and celebrity ties, including Snoop Dogg\'s Cali Red collaboration.',
      faqs: [{ question: 'What is the story behind 19 Crimes wine?', answer: 'The brand is named for 19 crimes that were punishable by exile to Australia during the British penal colony era, a theme reflected in its historical label art.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'duckhorn', brandKeywords: ['Duckhorn'], name: 'Duckhorn',
    seo: brandSeo({
      brand: 'Duckhorn', categoryLabel: 'Napa Valley Wine',
      titleTag: 'Duckhorn — Napa Valley Cabernet Sauvignon',
      h1: 'Duckhorn Wine — Cabernet Sauvignon Allocations',
      metaDescription: 'Buy Duckhorn online — flagship-tier Napa Valley Cabernet Sauvignon from the parent house of Decoy. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: "Duckhorn Vineyards' own Cabernet Sauvignon sits above Decoy, the brand's second label — a flagship-tier Napa Valley Cabernet from one of the region's most established producers.",
      faqs: [{ question: 'Is Decoy the same as Duckhorn?', answer: "Decoy is Duckhorn Vineyards' second label, made in a more accessible style and at a lower price point than Duckhorn's own flagship wines." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'kendall-jackson', brandKeywords: ['Kendall-Jackson', 'Kendall Jackson'], name: 'Kendall-Jackson',
    seo: brandSeo({
      brand: 'Kendall-Jackson', categoryLabel: 'California Wine',
      titleTag: 'Kendall-Jackson — Vintner\'s Reserve',
      h1: 'Kendall-Jackson Wine — Vintner\'s Reserve Allocations',
      metaDescription: 'Buy Kendall-Jackson online — Vintner\'s Reserve Sauvignon Blanc and Chardonnay from one of California\'s best-known wine brands. Direct allocations.',
      hook: "Kendall-Jackson's Vintner's Reserve tier is one of the best-recognized wine names in the US, sourced from California coastal vineyards.",
      faqs: [{ question: 'What is Vintner\'s Reserve?', answer: "Vintner's Reserve is Kendall-Jackson's flagship tier, spanning Chardonnay, Sauvignon Blanc, Cabernet Sauvignon, and more." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'william-hill', brandKeywords: ['William Hill'], name: 'William Hill',
    seo: brandSeo({
      brand: 'William Hill', categoryLabel: 'Napa Valley Wine',
      titleTag: 'William Hill — Napa Cabernet Sauvignon & Chardonnay',
      h1: 'William Hill Wine — Cabernet Sauvignon Allocations',
      metaDescription: 'Buy William Hill online — real demand in both Cabernet Sauvignon and Chardonnay tiers. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'William Hill Estate Winery produces both Cabernet Sauvignon and Chardonnay from California and Napa Valley fruit.',
      faqs: [{ question: 'Where does William Hill wine come from?', answer: 'William Hill Estate Winery sources from Napa Valley and broader California vineyards.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'robert-mondavi', brandKeywords: ['Robert Mondavi'], name: 'Robert Mondavi',
    seo: brandSeo({
      brand: 'Robert Mondavi', categoryLabel: 'Napa Valley Wine',
      titleTag: 'Robert Mondavi — Private Selection Cabernet Sauvignon',
      h1: 'Robert Mondavi Wine — Cabernet Sauvignon Allocations',
      metaDescription: 'Buy Robert Mondavi online — one of the most recognizable names in Napa Valley wine history. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Robert Mondavi is one of the most historically significant names in Napa Valley wine, credited with helping establish the region\'s global reputation.',
      faqs: [{ question: 'Why is Robert Mondavi historically important?', answer: 'Robert Mondavi founded his namesake Napa Valley winery in 1966 and is widely credited with helping establish Napa\'s global reputation for fine wine.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'austin-hope', brandKeywords: ['Austin Hope'], name: 'Austin Hope',
    seo: brandSeo({
      brand: 'Austin Hope', categoryLabel: 'Paso Robles Wine',
      titleTag: 'Austin Hope — Paso Robles Cabernet Sauvignon',
      h1: 'Austin Hope Wine — Cabernet Sauvignon Allocations',
      metaDescription: 'Buy Austin Hope online — a bold, full-bodied Paso Robles Cabernet Sauvignon with a strong critical reputation. Direct allocations at Aged & Amber.',
      hook: 'Austin Hope produces bold, full-bodied Paso Robles Cabernet Sauvignon from a region increasingly recognized for structured, sun-ripened reds.',
      faqs: [{ question: 'What region is Austin Hope wine from?', answer: 'Austin Hope is produced in Paso Robles, California.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'stags-leap', brandKeywords: ["Stags' Leap Winery", 'Stags Leap'], name: "Stags' Leap Winery",
    seo: brandSeo({
      brand: "Stags' Leap Winery", categoryLabel: 'Napa Valley Wine',
      titleTag: "Stags' Leap Winery — Napa Cabernet Sauvignon",
      h1: "Stags' Leap Wine — Cabernet Sauvignon Allocations",
      metaDescription: "Buy Stags' Leap Winery online — Cabernet Sauvignon from Napa Valley's historic Stags' Leap District. Direct allocations at Aged & Amber. Free $300+.",
      hook: "Stags' Leap Winery Cabernet Sauvignon comes from Napa Valley's historic Stags' Leap District, an AVA known for structured, age-worthy Cabernet.",
      faqs: [{ question: 'What is the Stags\' Leap District?', answer: "The Stags' Leap District is a small, historic Napa Valley AVA recognized for producing structured, age-worthy Cabernet Sauvignon." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'far-niente', brandKeywords: ['Far Niente'], name: 'Far Niente',
    seo: brandSeo({
      brand: 'Far Niente', categoryLabel: 'Napa Valley Wine',
      titleTag: 'Far Niente — Napa Valley Chardonnay',
      h1: 'Far Niente Wine — Chardonnay Allocations',
      metaDescription: 'Buy Far Niente online — a prestige Napa Valley Chardonnay from an estate dating to 1885. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Far Niente Chardonnay is a prestige-tier Napa Valley Chardonnay, produced by an estate dating to 1885.',
      faqs: [{ question: 'How old is Far Niente winery?', answer: 'Far Niente dates to 1885, making it one of the older continuously operating wineries in Napa Valley.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'turley', brandKeywords: ['Turley'], name: 'Turley',
    seo: brandSeo({
      brand: 'Turley', categoryLabel: 'Zinfandel',
      titleTag: 'Turley — Old Vine Zinfandel',
      h1: 'Turley Wine — Old Vine Zinfandel Allocations',
      metaDescription: 'Buy Turley online — a cult Zinfandel producer sourcing fruit from some of California\'s oldest surviving Zinfandel vineyards. Direct allocations.',
      hook: "Turley Wine Cellars has cult status among Zinfandel enthusiasts, sourcing fruit from some of California's oldest surviving Zinfandel vineyards.",
      faqs: [{ question: 'What makes Turley Zinfandel special?', answer: "Turley sources fruit from some of California's oldest surviving Zinfandel vineyards, producing a bold, concentrated style prized by collectors." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'rombauer', brandKeywords: ['Rombauer'], name: 'Rombauer',
    seo: brandSeo({
      brand: 'Rombauer', categoryLabel: 'California Wine',
      titleTag: 'Rombauer — Zinfandel & Chardonnay',
      h1: 'Rombauer Wine — Zinfandel Allocations',
      metaDescription: 'Buy Rombauer online — Zinfandel in the winery\'s signature rich, generous house style. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: "Rombauer's Zinfandel is made in the winery's signature rich, generous house style, the same approach that made its Chardonnay a category benchmark.",
      faqs: [{ question: 'Does Rombauer make more than Chardonnay?', answer: 'Yes — while best known for Chardonnay, Rombauer also produces Zinfandel and other varietals in the same rich house style.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'whitehaven', brandKeywords: ['Whitehaven'], name: 'Whitehaven',
    seo: brandSeo({
      brand: 'Whitehaven', categoryLabel: 'New Zealand Wine',
      titleTag: 'Whitehaven — Marlborough Sauvignon Blanc',
      h1: 'Whitehaven Wine — Sauvignon Blanc Allocations',
      metaDescription: 'Buy Whitehaven online — a well-established Marlborough, New Zealand Sauvignon Blanc. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: "Whitehaven is a well-established Marlborough Sauvignon Blanc producer, known for the region's signature bright, herbaceous style.",
      faqs: [{ question: 'What region is Whitehaven Sauvignon Blanc from?', answer: 'Whitehaven is produced in Marlborough, New Zealand, the region most associated with the bright, herbaceous Sauvignon Blanc style.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'kung-fu-girl', brandKeywords: ['Kung Fu Girl', 'Charles Smith'], name: 'Kung Fu Girl (Charles Smith)',
    seo: brandSeo({
      brand: 'Kung Fu Girl', categoryLabel: 'Washington Wine',
      titleTag: 'Kung Fu Girl — Charles Smith Wines Riesling',
      h1: 'Kung Fu Girl Wine — Riesling Allocations',
      metaDescription: 'Buy Kung Fu Girl online — Charles Smith Wines\' dry Riesling from Washington\'s Columbia Valley. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: "Kung Fu Girl is Charles Smith Wines' Riesling from Washington State's Columbia Valley, known for its playful, irreverent label.",
      faqs: [{ question: 'Who makes Kung Fu Girl Riesling?', answer: 'Kung Fu Girl is produced by Charles Smith Wines in Washington State.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'cupcake', brandKeywords: ['Cupcake'], name: 'Cupcake',
    seo: brandSeo({
      brand: 'Cupcake', categoryLabel: 'California Wine',
      titleTag: 'Cupcake — Moscato & Everyday Wine',
      h1: 'Cupcake Wine — Moscato Allocations',
      metaDescription: 'Buy Cupcake online — a major grocery-channel wine brand\'s sweet, aromatic Moscato. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Cupcake is a major grocery-channel wine brand offering approachable, everyday-priced wines across several varietals.',
      faqs: [{ question: 'Is Cupcake Moscato sweet?', answer: 'Yes — Cupcake Moscato is a sweet, floral, low-alcohol style aimed at approachable, everyday drinking.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'sandeman', brandKeywords: ['Sandeman'], name: 'Sandeman',
    seo: brandSeo({
      brand: 'Sandeman', categoryLabel: 'Port',
      titleTag: 'Sandeman — Historic Porto House',
      h1: 'Sandeman Port — Allocations',
      metaDescription: 'Buy Sandeman online — a historic Porto house recognizable by its silhouetted "Don" logo, also making sherry under the same name. Direct allocations.',
      hook: 'Sandeman is a historic Porto house recognizable by its silhouetted "Don" logo, producing both port and sherry under the same brand.',
      faqs: [{ question: 'Does Sandeman make sherry too?', answer: 'Yes — Sandeman produces both port from the Douro Valley and sherry from Jerez, Spain, under the same brand.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'kopke', brandKeywords: ['Kopke'], name: 'Kopke',
    seo: brandSeo({
      brand: 'Kopke', categoryLabel: 'Port',
      titleTag: 'Kopke — Oldest Port House, Est. 1638',
      h1: 'Kopke Port — Allocations',
      metaDescription: 'Buy Kopke online — the oldest port house in the Douro, founded 1638. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Kopke is the oldest port house in the Douro region, founded in 1638.',
      faqs: [{ question: 'How old is Kopke port house?', answer: 'Kopke was founded in 1638, making it the oldest port house in the Douro region.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'mirabeau', brandKeywords: ['Mirabeau'], name: 'Mirabeau',
    seo: brandSeo({
      brand: 'Mirabeau', categoryLabel: 'Provence Rosé',
      titleTag: 'Mirabeau — English-Owned Provence Rosé',
      h1: 'Mirabeau Rosé — Allocations',
      metaDescription: 'Buy Mirabeau online — an English-owned Côtes de Provence rosé estate. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Mirabeau is an English-owned Provence estate producing pale, dry Côtes de Provence rosé.',
      faqs: [{ question: 'Where is Mirabeau rosé from?', answer: "Mirabeau is produced in Côtes de Provence, France, though the estate is English-owned." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'coopers-hawk', brandKeywords: ["Cooper's Hawk"], name: "Cooper's Hawk",
    seo: brandSeo({
      brand: "Cooper's Hawk", categoryLabel: 'Dessert Wine',
      titleTag: "Cooper's Hawk — Lux Ice Wine",
      h1: "Cooper's Hawk Wine — Lux Ice Wine Allocations",
      metaDescription: "Buy Cooper's Hawk online — a US-made icewine-style dessert wine, an alternative to Canadian icewine brands. Direct allocations at Aged & Amber.",
      hook: "Cooper's Hawk Lux Ice Wine offers a domestically produced alternative to Canadian icewine, made in a concentrated, honeyed dessert-wine style.",
      faqs: [{ question: 'Is Cooper\'s Hawk Lux Ice Wine made like Canadian icewine?', answer: "It's made in a similar concentrated, honeyed dessert-wine style, but produced domestically in the US rather than Canada." }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'bartenura', brandKeywords: ['Bartenura'], name: 'Bartenura',
    seo: brandSeo({
      brand: 'Bartenura', categoryLabel: 'Kosher Wine',
      titleTag: 'Bartenura — Kosher Moscato',
      h1: 'Bartenura Wine — Moscato Allocations',
      metaDescription: 'Buy Bartenura online — the well-known kosher-market anchor brand\'s blue-bottle Moscato. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Bartenura, instantly recognizable by its blue bottle, is the anchor kosher-wine brand for Moscato in the US market.',
      faqs: [{ question: 'Why is Bartenura in a blue bottle?', answer: 'The distinctive cobalt blue bottle is a signature design choice that has made Bartenura one of the most recognizable kosher wine brands in the US.' }],
    }),
  },
  {
    categorySlug: 'fine-wine', hubSlug: 'bogle', brandKeywords: ['Bogle'], name: 'Bogle',
    seo: brandSeo({
      brand: 'Bogle', categoryLabel: 'California Wine',
      titleTag: 'Bogle — High-Value Family Estate Wine',
      h1: 'Bogle Wine — Cabernet Sauvignon, Pinot Noir & Merlot Allocations',
      metaDescription: 'Buy Bogle online — a family-owned California winery known for over-delivering at its price point. Direct allocations at Aged & Amber. Free $300+.',
      hook: 'Bogle Vineyards is a family-owned California winery whose wines are widely regarded for over-delivering at their price point.',
      faqs: [{ question: 'Is Bogle a family-owned winery?', answer: 'Yes — Bogle Vineyards is a family-owned California estate.' }],
    }),
  },
  ...
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'codorniu', brandKeywords: ['Codorníu', 'Codorniu', 'Anna de Codorníu'], name: 'Codorníu',
    seo: brandSeo({
      brand: 'Codorníu', categoryLabel: 'Cava',
      titleTag: 'Codorníu — Anna de Codorníu Cava',
      h1: 'Codorníu Cava — Anna de Codorníu Allocations',
      metaDescription: "Buy Codorníu online — Anna de Codorníu, Spain's best-selling Cava per the winery's own claim. Direct allocations at Aged & Amber. Free shipping on $300+.",
      hook: "Anna de Codorníu is a real, widely distributed Cava Codorníu markets as Spain's best-selling, named for Anna de Codorníu, who married into the family that founded the winery in 1551.",
      faqs: [{ question: 'How old is Codorníu?', answer: 'The Codorníu winery traces to 1551, one of the oldest wine-producing families in Spain.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'deutz', brandKeywords: ['Deutz'], name: 'Deutz',
    seo: brandSeo({
      brand: 'Deutz', categoryLabel: 'Champagne',
      titleTag: 'Deutz — Aÿ Grand Cru Champagne, Est. 1838',
      h1: 'Deutz Champagne — Brut Classic, Amour de Deutz & Rosé Allocations',
      metaDescription: 'Buy Deutz online — Brut Classic, prestige Amour de Deutz, and Brut Rosé from the Aÿ Grand Cru house founded 1838. Direct allocations at Aged & Amber.',
      hook: 'Deutz has produced Champagne from its Aÿ Grand Cru base since 1838, known for a refined, elegant house style.',
      faqs: [{ question: 'What is Amour de Deutz?', answer: "Amour de Deutz is Deutz's prestige Blanc de Blancs cuvée, made only in strong vintages from Grand Cru and Premier Cru Chardonnay." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'duval-leroy', brandKeywords: ['Duval-Leroy', 'Duval Leroy'], name: 'Duval-Leroy',
    seo: brandSeo({
      brand: 'Duval-Leroy', categoryLabel: 'Champagne',
      titleTag: 'Duval-Leroy — Independent Family Champagne House',
      h1: 'Duval-Leroy Champagne — Allocations',
      metaDescription: 'Buy Duval-Leroy online — one of the last large independently and family-owned Champagne houses, founded 1859. Direct allocations at Aged & Amber.',
      hook: 'Duval-Leroy, founded in 1859, is one of the last large Champagne houses still independently and family-owned.',
      faqs: [{ question: 'Is Duval-Leroy family-owned?', answer: 'Yes — Duval-Leroy remains one of the last large, independently and family-owned Champagne houses.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'henriot', brandKeywords: ['Henriot'], name: 'Henriot',
    seo: brandSeo({
      brand: 'Henriot', categoryLabel: 'Champagne',
      titleTag: 'Henriot — Independent Family Champagne, Est. 1808',
      h1: 'Henriot Champagne — Brut Souverain & Rosé Allocations',
      metaDescription: 'Buy Henriot online — an independent family house since 1808, also owner of Bouchard Père & Fils in Burgundy. Direct allocations at Aged & Amber.',
      hook: 'Henriot has remained an independent family house since 1808, also owning Burgundy\'s Bouchard Père & Fils.',
      faqs: [{ question: 'Does Henriot own other wineries?', answer: 'Yes — the Henriot family also owns Bouchard Père & Fils, a historic Burgundy producer.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'jacquesson', brandKeywords: ['Jacquesson'], name: 'Jacquesson',
    seo: brandSeo({
      brand: 'Jacquesson', categoryLabel: 'Champagne',
      titleTag: 'Jacquesson — Numbered 700-Series Champagne',
      h1: 'Jacquesson Champagne — Cuvée Allocations',
      metaDescription: 'Buy Jacquesson online — a house founded 1798, known for numbered "700-series" Cuvée releases rather than a fixed NV blend. Direct allocations.',
      hook: "Jacquesson has produced Champagne since 1798 and is known for numbering each 700-series Cuvée, varying vintage to vintage rather than keeping a fixed house style.",
      faqs: [{ question: 'What is the Jacquesson 700-series?', answer: "Jacquesson's core range is numbered sequentially (e.g. Cuvée 744, 745) rather than sold as a consistent non-vintage blend — each number reflects that specific harvest." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'mercier', brandKeywords: ['Mercier'], name: 'Mercier',
    seo: brandSeo({
      brand: 'Mercier', categoryLabel: 'Champagne',
      titleTag: 'Mercier — LVMH Champagne House, Est. 1858',
      h1: 'Mercier Champagne — Brut & Rosé Allocations',
      metaDescription: 'Buy Mercier online — a historic Épernay house, sister brand under LVMH alongside Moët, founded 1858. Direct allocations at Aged & Amber. Free $300+.',
      hook: 'Mercier was founded in Épernay in 1858 and today sits alongside Moët & Chandon under LVMH.',
      faqs: [{ question: 'Is Mercier related to Moët & Chandon?', answer: 'Yes — both are Champagne houses owned by LVMH, with Mercier positioned as a more accessible entry point.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'bruno-paillard', brandKeywords: ['Bruno Paillard'], name: 'Bruno Paillard',
    seo: brandSeo({
      brand: 'Bruno Paillard', categoryLabel: 'Champagne',
      titleTag: 'Bruno Paillard — Récoltant-Manipulant House, Est. 1981',
      h1: 'Bruno Paillard Champagne — Première Cuvée Allocations',
      metaDescription: 'Buy Bruno Paillard online — a respected récoltant-manipulant house founded 1981, notable for hand-riddling. Direct allocations at Aged & Amber.',
      hook: 'Bruno Paillard founded his own house in 1981, building a reputation for meticulous, hand-riddled production and being among the first houses to print disgorgement dates on the back label.',
      faqs: [{ question: 'What is a récoltant-manipulant?', answer: 'A grower-producer who grows their own grapes and makes their own Champagne, rather than buying fruit or finished wine from others.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'philipponnat', brandKeywords: ['Philipponnat'], name: 'Philipponnat',
    seo: brandSeo({
      brand: 'Philipponnat', categoryLabel: 'Champagne',
      titleTag: 'Philipponnat — Real Grower-House Champagne',
      h1: 'Philipponnat Champagne — Royale Réserve Allocations',
      metaDescription: 'Buy Philipponnat online — a real, well-regarded grower-house whose Clos des Goisses is a genuinely famous single-vineyard cuvée. Direct allocations.',
      hook: 'Philipponnat is best known for Clos des Goisses, a genuinely famous single-vineyard cuvée; Royale Réserve is the house\'s accessible entry point.',
      faqs: [{ question: 'What is Clos des Goisses?', answer: "Clos des Goisses is Philipponnat's famous single-vineyard prestige cuvée, one of the most celebrated individual Champagne vineyards." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'schramsberg', brandKeywords: ['Schramsberg'], name: 'Schramsberg',
    seo: brandSeo({
      brand: 'Schramsberg', categoryLabel: 'California Sparkling Wine',
      titleTag: 'Schramsberg — California Méthode Champenoise',
      h1: 'Schramsberg Sparkling Wine — J. Schram Allocations',
      metaDescription: "Buy Schramsberg online — J. Schram, the California sparkling house's own real prestige tier. Direct allocations at Aged & Amber. Free shipping on $300+.",
      hook: "J. Schram is Schramsberg's prestige-tier sparkling wine, named for the winery's 19th-century founder, made using the traditional méthode champenoise the house pioneered in California.",
      faqs: [{ question: 'Is Schramsberg Champagne?', answer: "No — Schramsberg is a California sparkling wine made using the traditional méthode champenoise; only wine from the Champagne region of France can legally be called Champagne." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'josh-cellars', brandKeywords: ['Josh Cellars'], name: 'Josh Cellars',
    seo: brandSeo({
      brand: 'Josh Cellars', categoryLabel: 'Prosecco',
      titleTag: 'Josh Cellars — Prosecco',
      h1: 'Josh Cellars Prosecco — Allocations',
      metaDescription: 'Buy Josh Cellars Prosecco online — a natural line extension for a brand the site already carries 5 wine SKUs of. Direct allocations at Aged & Amber.',
      hook: "Josh Cellars Prosecco extends the brand's real, widely stocked lineup into sparkling wine.",
      faqs: [{ question: 'Does Josh Cellars make sparkling wine?', answer: 'Yes — Josh Cellars offers both a standard Prosecco and a Prosecco Rosé.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'cupcake', brandKeywords: ['Cupcake'], name: 'Cupcake',
    seo: brandSeo({
      brand: 'Cupcake', categoryLabel: 'Prosecco',
      titleTag: 'Cupcake — Prosecco',
      h1: 'Cupcake Prosecco — Allocations',
      metaDescription: "Buy Cupcake Prosecco online — a large-scale grocery-channel brand's real Prosecco extension. Direct allocations at Aged & Amber. Free shipping on $300+.",
      hook: 'Cupcake Prosecco extends the major grocery-channel wine brand into sparkling wine.',
      faqs: [{ question: 'Is Cupcake a big wine brand?', answer: 'Yes — Cupcake is a large-scale grocery-channel wine brand with wide US distribution.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'zonin', brandKeywords: ['Zonin'], name: 'Zonin',
    seo: brandSeo({
      brand: 'Zonin', categoryLabel: 'Prosecco',
      titleTag: 'Zonin — Major Veneto Prosecco House',
      h1: 'Zonin Prosecco — Allocations',
      metaDescription: 'Buy Zonin online — a major Veneto Prosecco house with real, established US distribution, producing wine since 1821. Direct allocations at Aged & Amber.',
      hook: 'Zonin has produced Italian wine since 1821 and is a major Veneto Prosecco house with genuine, wide US distribution.',
      faqs: [{ question: 'How old is Zonin?', answer: 'Zonin has produced Italian wine since 1821.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'avissi', brandKeywords: ['Avissi'], name: 'Avissi',
    seo: brandSeo({
      brand: 'Avissi', categoryLabel: 'Prosecco',
      titleTag: 'Avissi — Veneto Prosecco',
      h1: 'Avissi Prosecco — Extra Dry & DOC Allocations',
      metaDescription: 'Buy Avissi online — a real, established Prosecco brand from the Veneto. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Avissi is a real, established Veneto Prosecco brand, offered here in both Extra Dry and base DOC tiers.',
      faqs: [{ question: 'What does Extra Dry mean on Prosecco?', answer: 'Extra Dry carries slightly more residual sugar than a Brut classification, giving a rounder, gently sweet style.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'lunetta', brandKeywords: ['Lunetta'], name: 'Lunetta',
    seo: brandSeo({
      brand: 'Lunetta', categoryLabel: 'Prosecco',
      titleTag: 'Lunetta — Cavit-Owned Prosecco',
      h1: 'Lunetta Prosecco — Allocations',
      metaDescription: 'Buy Lunetta online — a Cavit-owned, widely available Prosecco brand. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: "Lunetta is owned by Cavit, one of Italy's largest wine cooperatives.",
      faqs: [{ question: 'Who owns Lunetta Prosecco?', answer: "Lunetta is owned by Cavit, one of Italy's largest wine cooperatives." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'la-vostra', brandKeywords: ['La Vostra'], name: 'La Vostra',
    seo: brandSeo({
      brand: 'La Vostra', categoryLabel: 'Prosecco',
      titleTag: 'La Vostra — Everyday Prosecco',
      h1: 'La Vostra Prosecco — Allocations',
      metaDescription: 'Buy La Vostra online — a real, established Prosecco brand at an accessible everyday price. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'La Vostra is a real, established Prosecco brand with wide US retail distribution.',
      faqs: [{ question: 'Does La Vostra make a rosé?', answer: 'Yes — La Vostra offers both a standard Prosecco and a DOC Rosé Prosecco.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'riondo', brandKeywords: ['Riondo'], name: 'Riondo',
    seo: brandSeo({
      brand: 'Riondo', categoryLabel: 'Prosecco',
      titleTag: 'Riondo — Veneto DOC Prosecco',
      h1: 'Riondo Prosecco — Extra Dry & Rosé Allocations',
      metaDescription: 'Buy Riondo online — a real, established Prosecco DOC brand. Direct allocations at Aged & Amber. Free shipping on $300+.',
      hook: 'Riondo is a real, established Prosecco DOC brand, offered here in both Extra Dry and Rosé tiers.',
      faqs: [{ question: 'What region is Riondo Prosecco from?', answer: 'Riondo is produced in the Veneto region of Italy under the Prosecco DOC designation.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'coppola', brandKeywords: ['Francis Ford Coppola', 'Coppola'], name: 'Francis Ford Coppola Winery',
    seo: brandSeo({
      brand: 'Francis Ford Coppola Winery', categoryLabel: 'Prosecco',
      titleTag: 'Francis Ford Coppola — Diamond Collection Prosecco',
      h1: 'Francis Ford Coppola Prosecco — Allocations',
      metaDescription: "Buy Francis Ford Coppola Winery online — Diamond Collection Prosecco from the filmmaker's real wine label. Direct allocations at Aged & Amber.",
      hook: "Francis Ford Coppola Winery's Diamond Collection Prosecco extends the filmmaker's real wine label into sparkling wine.",
      faqs: [{ question: 'Is Francis Ford Coppola\'s winery real?', answer: 'Yes — the filmmaker owns and operates Francis Ford Coppola Winery in Sonoma County, California, a genuine, long-running wine business.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'asolo', brandKeywords: ['Asolo'], name: 'Asolo',
    seo: brandSeo({
      brand: 'Asolo', categoryLabel: 'Prosecco',
      titleTag: 'Asolo — Distinct DOCG Prosecco Zone',
      h1: 'Asolo Prosecco Superiore — Allocations',
      metaDescription: 'Buy Asolo online — Asolo Prosecco Superiore DOCG, a distinct, real DOCG zone separate from Valdobbiadene. Direct allocations at Aged & Amber.',
      hook: 'Asolo Prosecco Superiore is a genuine, distinct DOCG zone in its own right, separate from the better-known Valdobbiadene.',
      faqs: [{ question: 'Is Asolo the same as Valdobbiadene Prosecco?', answer: 'No — Asolo and Valdobbiadene are two separate, legally distinct DOCG zones within the Prosecco Superiore designation.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'kim-crawford', brandKeywords: ['Kim Crawford'], name: 'Kim Crawford',
    seo: brandSeo({
      brand: 'Kim Crawford', categoryLabel: 'Prosecco',
      titleTag: 'Kim Crawford — New Zealand Wine Brand Prosecco',
      h1: 'Kim Crawford Prosecco — Allocations',
      metaDescription: "Buy Kim Crawford online — a major New Zealand wine brand's real Prosecco extension. Direct allocations at Aged & Amber. Free shipping on $300+.",
      hook: 'Kim Crawford, a major New Zealand wine brand best known for Sauvignon Blanc, extends into Italian Prosecco with this real, DOC-classified sparkling wine.',
      faqs: [{ question: 'Is Kim Crawford a New Zealand or Italian brand?', answer: 'Kim Crawford is a New Zealand wine brand best known for Sauvignon Blanc; its Prosecco is sourced from and produced in Italy.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'belaire', brandKeywords: ['Luc Belaire', 'Belaire'], name: 'Luc Belaire',
    seo: brandSeo({
      brand: 'Luc Belaire', categoryLabel: 'Sparkling Rosé',
      titleTag: 'Luc Belaire — Hip-Hop Crossover Sparkling Rosé',
      h1: 'Luc Belaire Rare Rosé — Allocations',
      metaDescription: 'Buy Luc Belaire online — a strong hip-hop and culture crossover brand with real recognition beyond wine circles. Direct allocations at Aged & Amber.',
      hook: 'Luc Belaire Rare Rosé has built strong crossover recognition through hip-hop and pop culture.',
      faqs: [{ question: 'Why is Belaire popular in hip-hop culture?', answer: "Luc Belaire built strong crossover recognition through celebrity and hip-hop culture associations, becoming a fixture at nightlife and celebration occasions." }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'mcbride-sisters', brandKeywords: ['McBride Sisters'], name: 'McBride Sisters',
    seo: brandSeo({
      brand: 'McBride Sisters', categoryLabel: 'Sparkling Wine',
      titleTag: 'McBride Sisters — Largest Black-Owned Wine Company',
      h1: 'McBride Sisters Sparkling Wine — Brut & Rosé Allocations',
      metaDescription: 'Buy McBride Sisters online — the largest Black-owned wine company in the US, founded by sisters Robin and Andréa McBride. Direct allocations.',
      hook: 'McBride Sisters is the largest Black-owned wine company in the US, founded by sisters Robin and Andréa McBride.',
      faqs: [{ question: 'Who founded McBride Sisters?', answer: 'McBride Sisters was founded by half-sisters Robin and Andréa McBride, and is the largest Black-owned wine company in the US.' }],
    }),
  },
  {
    categorySlug: 'champagne-sparkling', hubSlug: 'barefoot', brandKeywords: ['Barefoot'], name: 'Barefoot',
    seo: brandSeo({
      brand: 'Barefoot', categoryLabel: 'Sparkling Wine',
      titleTag: 'Barefoot Bubbly — Grocery-Channel Sparkling Wine',
      h1: 'Barefoot Bubbly — Brut & Pink Moscato Allocations',
      metaDescription: 'Buy Barefoot Bubbly online — a major grocery-channel brand\'s sparkling extension, alongside the site\'s stocked Barefoot Fine Wine SKUs. Direct allocations.',
      hook: "Barefoot Bubbly extends the brand's massive grocery-channel presence into sparkling wine, spanning a dry Brut Cuvée and a sweet Pink Moscato.",
      faqs: [{ question: 'Does Barefoot make sparkling wine?', answer: "Yes — Barefoot Bubbly includes a Brut Cuvée and a sweet Pink Moscato, alongside the brand's still-wine lineup." }],
    }),
  },
